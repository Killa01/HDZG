...
import static CityInfo.GameFormula.getCityAttack;
import static CityInfo.GameFormula.getCityDefence;
import static CityInfo.GameFormula.getHeroAttack;
import static CityInfo.GameFormula.getHeroDefence;
import static Layer.ConstantUtil.CITY_INFO;
import static Layer.ConstantUtil.COUNTRY_NAME;
import static Layer.ConstantUtil.DIALOG_BTN_HEIGHT;
import static Layer.ConstantUtil.DIALOG_BTN_SPAN;
import static Layer.ConstantUtil.DIALOG_BTN_START_X;
import static Layer.ConstantUtil.DIALOG_BTN_START_Y;
import static Layer.ConstantUtil.DIALOG_BTN_WIDTH;
import static Layer.ConstantUtil.DIALOG_BTN_WORD_LEFT;
import static Layer.ConstantUtil.DIALOG_BTN_WORD_UP;
import static Layer.ConstantUtil.DIALOG_START_Y;
import static Layer.ConstantUtil.DIALOG_WORD_SIZE;
...
public class CityDrawable extends MyMeetableDrawable implements Externalizable{
	...
	public int status= 0;//为0绘制询问，为1显示战斗结果,2表示攻克城池，3表示没兵可打仗了，4表示来到自己的城池，5表示onTouch监听器为将领选择器
