...
public abstract class Skill implements Serializable{
	...
	public int id;//技能id，惟一标识一个技能
	String name;//技能的名字 
	protected int proficiencyLevel;//技能熟练度
	public int strengthCost;//每次释放消耗的体力
	protected int basicEarning;//收入的单位，用于计算英雄的总收入
	protected int tempProficiency;//临时熟练度，到一定程度会增加技能熟练度
	protected int proficiencyToUpgrade;//技能熟练度升级需要的临时熟练度
	int skillType;//技能类型，包括0:生活技能、1:战斗技能、2:普通技能
	protected Hero hero;//所属英雄的引用
