 ...
 */
import static Layer.ConstantUtil.DOWN;
import static Layer.ConstantUtil.GAME_VIEW_SCREEN_COLS;
import static Layer.ConstantUtil.GAME_VIEW_SCREEN_ROWS;
import static Layer.ConstantUtil.HERO_MOVING_SLEEP_SPAN;
import static Layer.ConstantUtil.HERO_MOVING_SPAN;
import static Layer.ConstantUtil.HERO_WAIT_SPAN;
import static Layer.ConstantUtil.LEFT;
import static Layer.ConstantUtil.MAP_COLS;
import static Layer.ConstantUtil.MAP_ROWS;
import static Layer.ConstantUtil.RIGHT;
import static Layer.ConstantUtil.ROLL_SCREEN_SPACE_DOWN;
import static Layer.ConstantUtil.ROLL_SCREEN_SPACE_LEFT;
import static Layer.ConstantUtil.ROLL_SCREEN_SPACE_RIGHT;
import static Layer.ConstantUtil.ROLL_SCREEN_SPACE_UP;
import static Layer.ConstantUtil.SCREEN_HEIGHT;
import static Layer.ConstantUtil.SCREEN_WIDTH;
import static Layer.ConstantUtil.TILE_SIZE;
import static Layer.ConstantUtil.UP;
...
public class HeroGoThread extends Thread implements Serializable{
	...
	public boolean isMoving;//英雄是否在走标志位
