...
import wyf.ytl.WarAlert;

import CityInfo.FoodAlert;
import CityInfo.GameView;
import Layer.CityDrawable;
import MeetableLayer.PlainAlert;

public class HeroBackDataThread extends Thread{

	Hero hero;//英雄的引用
	public boolean flag;//线程是否执行标志位
	public int sleepSpan = 1000000;//休眠时间
	public int foodCount = 0;//执行5循环才修改粮草
	public int warCount = 0;//执行10次循环才增加有几率爆发战争
