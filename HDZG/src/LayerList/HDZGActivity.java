...
import Layer.ScreenRollView;
import Layer.SerializableGame;
import Layer.SoundManageView;
import Layer.SoundView;
import MeetableLayer.ManPanelView;
import MeetableLayer.MenuView;
...
public class HDZGActivity extends Activity {
	public LoadingView loadingView;//进度条界面的引用
	public MenuView menuView;//开始游戏的主菜单界面   
	public GameView gameView;//游戏主界面
	...
	public boolean isStartSound = true;//开场声音
	public boolean isBattleSound = true;//战斗声音
	public boolean isEnvironmentSound = true;//环境音
